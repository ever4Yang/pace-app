...
- **Metric and imperial**: Switch between metric (km, min/km) and imperial (mi, min/mi) units.
...
3. Copy the `.env.example` file to `.env` and set `EXPO_PUBLIC_MAPTILER_API_KEY` to your [MapTiler](https://www.maptiler.com/) API key
